...
1. Create a directory for your work.
    ...
    ```
2. Move the `Chinook_Sqlite.sqlite` file that you downloaded to that directory
    ```
...
1. Once you get a SQL statement working for one of the exercises, copy and the SQL statement and paste it into the corresponding file for the exercise (_see below_). If your query doesn't return the expected results, try try again.

For each of the following exercises, provide the appropriate query. Everything from class and the [Sqlite Documentation](http://www.sqlite.org/) is fair game.
